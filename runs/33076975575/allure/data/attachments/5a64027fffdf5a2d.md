...
- Name: healthpassport.spec.ts >> verify 90 days health passport report PDF data 
- Location: tests/healthpassport.spec.ts:262:5
          ...
          - generic [ref=e168]:
            ...
            - generic [ref=e186]:
              ...
              - tabpanel "Overview" [ref=e222]:
                - generic [ref=e223]:
                  - generic [ref=e224]:
                    - button "Weight 335.0 lbs" [ref=e225] [cursor=pointer]:
                      - generic [ref=e226]:
                        - generic [ref=e227]: Weight
                        - generic [ref=e235]:
                          - generic [ref=e236]: "335.0"
                          - generic [ref=e237]: lbs
                    - button "BMI 51.4" [ref=e238] [cursor=pointer]:
                      - generic [ref=e239]:
                        - generic [ref=e240]: BMI
                        - generic [ref=e247]: "51.4"
                    - button "Glucose TIR 44 %" [ref=e250] [cursor=pointer]:
                      - generic [ref=e251]:
                        - generic [ref=e252]: Glucose TIR
                        - generic [ref=e260]:
                          - generic [ref=e261]: "44"
                          - generic [ref=e262]: "%"
                    - button "Avg Sleep (logged days) 6.2 hrs" [ref=e263] [cursor=pointer]:
                      - generic [ref=e264]:
                        - generic [ref=e265]: Avg Sleep (logged days)
                        - generic [ref=e272]:
                          - generic [ref=e273]: "6.2"
                          - generic [ref=e274]: hrs
                    - button "Avg Steps (logged days) 3,761" [ref=e275] [cursor=pointer]:
                      - generic [ref=e276]:
                        - generic [ref=e277]: Avg Steps (logged days)
                        - generic [ref=e283]: 3,761
                    - button "Avg Nutrition (logged days) 1997 cal/day" [ref=e286] [cursor=pointer]:
                      - generic [ref=e287]:
                        - generic [ref=e288]: Avg Nutrition (logged days)
                        - generic [ref=e296]:
                          - generic [ref=e297]: "1997"
...
> 95  |         const result = await parser.getText();
  ...
  99  |     }
  100 | 
  101 |     async clickOnTab(tabName: string): Promise<void> {
  102 |         await this.page.getByRole('tab', { name: tabName }).click();
  103 |     }
  104 | 
  105 |     async downloadCsv(
  106 |         type: string,
  107 |         downloadPath: string
  108 |     ): Promise<string> {
  109 | 
  110 |         const [download] = await Promise.all([
  111 |             this.page.waitForEvent('download'),
  112 |             this.page.getByRole('button', {
  113 |                 name: `Download ${type}`
  114 |             }).click()
  115 |         ]);
  116 | 
  117 |         const filePath = path.join(
  118 |             downloadPath,
  119 |             await download.suggestedFilename()
  120 |         );
  121 | 
  122 |         await download.saveAs(filePath);
  123 | 
  124 |         return filePath;
  125 |     }
  126 | 
